...
exports.UniversalEdgarEngine = void 0;
const query_parser_1 = require("./query-parser");
const knowledge_extractor_1 = require("./knowledge-extractor");
const knowledge_synthesizer_1 = require("./knowledge-synthesizer");
const mcp_query_router_1 = require("../../backend/src/services/mcp-query-router");
class UniversalEdgarEngine {
    constructor() {
        this.queryParser = new query_parser_1.UniversalQueryParser();
        this.knowledgeExtractor = new knowledge_extractor_1.KnowledgeExtractionEngine();
        this.synthesizer = new knowledge_synthesizer_1.KnowledgeSynthesizer();
    ...
    async processQuery(naturalLanguageQuery) {
        ...
        try {
            ...
            try {
                ...
                if (!this.mcpRouter) {
                    this.mcpRouter = (0, mcp_query_router_1.getMCPQueryRouter)();
                }
                // Try MCP route first
    ...
    generateLowConfidenceResponse(originalQuery, parsedQuery) {
        return {
...
- "Show me Google's latest 10-K filing"`,
    ...
    generateInsufficientDataResponse(originalQuery, parsedQuery, knowledgeSet) {
...
- Specifying the type of information you're looking for`,
    ...
    generateErrorResponse(originalQuery, error) {
...
Error details: ${error.message || 'Unknown error occurred'}`,
    ...
    convertMCPToKnowledgeSet(mcpResult, query) {
...
exports.UniversalEdgarEngine = UniversalEdgarEngine;
//# sourceMappingURL=universal-edgar-engine.js.map